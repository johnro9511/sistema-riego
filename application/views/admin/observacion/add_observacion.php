                    ...
                    <div class="col-md-12">
                        ...
                        <form id="addObs"  method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="desc_obs" name="desc_obs" required>
                            </div>
                            <div class="form-group">
                                <label for="foto_zona">Evidencia:</label>
                                <input type="file" id="foto_zona" name="foto_zona" class="dropify" data-allowed-file-extensions = " jpg png jpeg gif bmp" data-max-file-size="15M" />
                            </div>
                            <div class="form-group">
