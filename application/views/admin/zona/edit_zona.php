            ...
            <div class="box-body">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <form id="editZona" method="POST">
                            <input type="hidden" value="<?php echo $zona->id_zona;?>" name="id_zona">
                            <div class="form-group">
                                <label for="nom_zona">Descripción:</label>
                                <input type="text" class="form-control" id="nom_zona" name="nom_zona" value="<?php echo $zona->nom_zona; ?>" required>
                            </div>
                            <div class="form-group">
                                <label for='ubicacion'>Ubicación: </label>
                                <select name='id_ubi' id='id_ubi' class="form-control" required>
                                    <option value="<?php echo $zona->id_ubi;?>"> <?php echo $zona->desc_ubi;?> </option>
                                      <?php 
                                        if (count($ubicacion)) {
                            ...
                            <div class="form-group">
                                ...
                                <select name='id_cultivo' id='id_cultivo' class="form-control" required>
                                  <option value="<?php echo $zona->id_cultivo;?>"> <?php echo $zona->desc_cultivo;?> </option>
                                    <?php
                                          if (count($cultivo)) {
                            ...
                            <div class="form-group">
                                ...
                                <select name='id_suelo' id='id_suelo' class="form-control" required>
                                  <option value="<?php echo $zona->id_suelo;?>"> <?php echo $zona->desc_suelo;?> </option>
                                    <?php
                                          if (count($suelo)) {
                            ...
                            <div class="form-group">
                                ...
                                <select name='id_comp' id='id_comp' class="form-control" required>
                                  <option value="<?php echo $zona->id_comp;?>"> <?php echo $zona->nom_comp;?> </option>
                                    <?php
                                          if (count($compuesto)) {
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control" id="fec_inicio" name="fec_inicio" value="<?php echo $zona->fec_inicio; ?>" required>
                            </div>
                            <div class="form-group">
