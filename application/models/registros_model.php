...
class registros_model extends CI_Model {
	...
	public function getregs(){
		$sql = "select r.*,z.nom_zona,u.desc_ubi,date(r.fechahora) as fecha,time(r.fechahora) as hora from registros r inner join zona z on r.id_zona = z.id_zona inner join ubicacion u on r.id_ubi = u.id_ubi;";
